...
public class UserImp implements User {
    ...
    public void JobSeekerRegister(JobModel jobModel) {
        try {
            ...
            preparedStatement.setString(1, jobModel.getUserName());
            preparedStatement.setString(2, jobModel.getDob());
            preparedStatement.setString(3, jobModel.getEmail());
            preparedStatement.setString(4, jobModel.getPassword());
    ...
    public void EmployerRegister(EmployerModel employerModel) {
        try {
            PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO Employee (EName, Department,Eemail,CompanyName,password) VALUES (?, ?, ?, ?,?)");
            ...
            preparedStatement.setString(4, employerModel.getCompanyName());
            preparedStatement.setString(5, employerModel.getPassword());
            int res=preparedStatement.executeUpdate();
            if(res>0){
                System.out.println("User Registered Successfully");
